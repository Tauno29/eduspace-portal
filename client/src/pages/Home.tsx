...
export const APK_DOWNLOAD_URL = "https://github.com/Tauno29/eduspace-portal/releases/download/v1.0.5/eduspace-latest.apk";
  ...
  return (
    <div className={`brand-lockup ${compact ? "brand-lockup--compact" : ""}`}>
      <div className="brand-mark" aria-hidden="true">
        <img src={assetUrl("/assets/eduspace-logo.jpg")} alt="" />
      </div>
  ...
  return (
    <div className="device-stage" aria-label="EduSpace app preview">
      ...
      <div className="phone-shell phone-shell--real">
        <img className="phone-homepage" src={assetUrl("/assets/eduspace-homepage.jpeg")} alt="EduSpace app homepage showing school regions and navigation" />
      </div>
    </div>
  );
}
  ...
  return (
    <div className="site-shell">
      <header className={`site-header ${menuOpen ? "site-header--open" : ""}`}>
        ...
        {menuOpen && <nav className="mobile-nav" aria-label="Mobile navigation"><button onClick={() => scrollTo("features")}>Features <ArrowRight size={16} /></button><button onClick={() => scrollTo("install")}>How to install <ArrowRight size={16} /></button><button onClick={() => scrollTo("faqs")}>FAQs <ArrowRight size={16} /></button></nav>}
      </header>
